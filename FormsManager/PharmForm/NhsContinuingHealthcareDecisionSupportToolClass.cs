...
{
    public class NhsContinuingHealthcareDecisionSupportToolClass
    {
        ...
        {
            var doc = Resources.NhsContinuingHealthcareDecisionSupportTool;
            ...
            var fileName = Path.Combine(postPath, "NhsContinuingHealthcareDecisionSupportTool.doc");
            try
            {
            ...
            {
                const string errorName = "NhsContinuingHealthcareDecisionSupportTool Form";
