...
{
    public class ZoledronicAcidPhysicianOrderClass
    {
        ...
        {
            var doc = Resources.ZoledronicAcidPhysicianOrder;
            ...
            var fileName = Path.Combine(postPath, "ZoledronicAcidPhysicianOrder.pdf");
            try
            {
            ...
            {
                const string errorName = "ZoledronicAcidPhysicianOrder Form";
