...
{
    public class SapphireQuickStartGuideClass
    {
        ...
        {
            var doc = Resources.SapphireQuickStartGuide;
            ...
            var fileName = Path.Combine(postPath, "SapphireQuickStartGuide.pdf");
            try
            {
            ...
            {
                const string errorName = "SapphireQuickStartGuide Form";
