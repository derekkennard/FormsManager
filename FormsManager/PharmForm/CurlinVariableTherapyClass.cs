...
{
    public class CurlinVariableTherapyClass
    {
        ...
        {
            var doc = Resources.CURLIN_Variable_Therapy;
            ...
            var fileName = Path.Combine(postPath, "CURLIN_Variable_Therapy.pdf");
            try
            {
            ...
            {
                const string errorName = "CURLIN_Variable_Therapy Form";
