...
{
    public class WashingtonStateGuideClass
    {
        ...
        {
            var doc = Resources.WashingtonStateInfusionGuideline;
            ...
            var fileName = Path.Combine(postPath, "WashingtonStateInfusionGuideline.pdf");
            try
            {
            ...
            {
                const string errorName = "Washington State Infusion Guideline Form";
