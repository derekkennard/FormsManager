...
namespace FormsManager.PharmForm
{
    public class Ma430Class
    {
        ...
        public static void GetForm()
        {
            ...
            var fileName = Path.Combine(postPath, "Ma430Form.pdf");
            try
            {
            ...
            {
                const string errorName = "Home Infusion Therapy Prior Authorization Form";
                ...
                Log.Debug("Error from :" + Environment.UserName + " for " + errorName + "with error message: " + e.StackTrace);
            }
