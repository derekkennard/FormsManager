...
namespace FormsManager.PharmForm
{
    public class CurlinPcaClass
    {
        ...
        {
            var doc = Resources.CURLIN_PCA_Therapy;
            ...
            var fileName = Path.Combine(postPath, "CURLIN_PCA_Therapy.pdf");
            try
            {
            ...
            {
                const string errorName = "CURLIN_PCA_Therapy";
