...
{
    public class HomeInfusionSafetyGuideClass
    {
        ...
        {
            var doc = Resources.HomeInfusionSafetyGuide;
            ...
            var fileName = Path.Combine(postPath, "HomeInfusionSafetyGuide.pdf");
            try
            {
            ...
            {
                const string errorName = "Home Infusion Safety Guide Form";
