...
{
    public class MedPharmHitValidationClass
    {
        ...
        {
            var doc = Resources.MedPharmHitValidation;
            ...
            var fileName = Path.Combine(postPath, "MedPharmHitValidation.pdf");
            try
            {
            ...
            {
                const string errorName = "MedPharmHitValidation Form";
