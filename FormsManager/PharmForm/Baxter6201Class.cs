...
namespace FormsManager.PharmForm
{
    public class Baxter6201Class
    {
        ...
        {
            var doc = Resources.Baxter_6201_Tips;
            ...
            var fileName = Path.Combine(postPath, "Baxter-6201-Tips.pdf");
            try
            {
            ...
            {
                const string errorName = "Baxter 6201 Tips Form";
