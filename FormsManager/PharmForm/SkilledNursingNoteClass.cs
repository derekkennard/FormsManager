...
{
    public class SkilledNursingNoteClass
    {
        ...
        {
            var doc = Resources.SkilledNursingNote;
            ...
            var fileName = Path.Combine(postPath, "SkilledNursingNote.pdf");
            try
            {
            ...
            {
                const string errorName = "SkilledNursingNote Form";
