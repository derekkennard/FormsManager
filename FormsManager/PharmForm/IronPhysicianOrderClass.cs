...
{
    public class IronPhysicianOrderClass
    {
        ...
        {
            var doc = Resources.IronPhysicianOrder;
            ...
            var fileName = Path.Combine(postPath, "IronPhysicianOrder.pdf");
            try
            {
            ...
            {
                const string errorName = "IronPhysicianOrder Form";
