...
{
    public class IvigPhysOrderClass
    {
        ...
        {
            var doc = Resources.IvigPhysOrder;
            ...
            var fileName = Path.Combine(postPath, "IvigPhysOrder.pdf");
            try
            {
            ...
            {
                const string errorName = "IvigPhysOrder Form";
