...
{
    public class HizentraInfusionGuideClass
    {
        ...
        {
            var doc = Resources.HizentraInfusionGuide;
            ...
            var fileName = Path.Combine(postPath, "HizentraInfusionGuide.pdf");
            try
            {
            ...
            {
                const string errorName = "Hizentra Infusion Guide Form";
