...
{
    public class InfusionCaregiverGuideClass
    {
        ...
        {
            var doc = Resources.InfusionCaregiverGuide;
            ...
            var fileName = Path.Combine(postPath, "InfusionCaregiverGuide.pdf");
            try
            {
            ...
            {
                const string errorName = "Infusion Caregiver Guide Form";
