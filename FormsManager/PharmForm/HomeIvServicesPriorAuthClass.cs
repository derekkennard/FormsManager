...
{
    public class HomeIvServicesPriorAuthClass
    {
        ...
        {
            var doc = Resources.HomeIvServicesPriorAuth;
            ...
            var fileName = Path.Combine(postPath, "HomeIvServicesPriorAuth.pdf");
            try
            {
            ...
            {
                const string errorName = "HomeIvServicesPriorAuth Form";
