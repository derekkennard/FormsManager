...
{
    public class AbiOrderFormClass
    {
        ...
        {
            var doc = Resources.AbiOrderForm;
            ...
            var fileName = Path.Combine(postPath, "AbiOrderForm.pdf");
            try
            {
            ...
            {
                const string errorName = "Antibiotics Referral Order Form";
