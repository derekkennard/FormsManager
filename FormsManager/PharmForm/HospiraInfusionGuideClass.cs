...
{
    public class HospiraInfusionGuideClass
    {
        ...
        {
            var doc = Resources.HospiraInfusionGuide;
            ...
            var fileName = Path.Combine(postPath, "HospiraInfusionGuide.pdf");
            try
            {
            ...
            {
                const string errorName = "Hospira Infusion Guide Form";
