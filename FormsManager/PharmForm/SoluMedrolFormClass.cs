...
{
    public class SoluMedrolFormClass
    {
        ...
        {
            var doc = Resources.SoluMedrolForm;
            ...
            var fileName = Path.Combine(postPath, "SoluMedrolForm.pdf");
            try
            {
            ...
            {
                const string errorName = "SoluMedrolForm Form";
