...
namespace FormsManager.PharmForm
{
    public class CurlinTpnClass
    {
        ...
        {
            var doc = Resources.CURLIN_TPN_Therapy;
            ...
            var fileName = Path.Combine(postPath, "CURLIN_TPN_Therapy.pdf");
            try
            {
            ...
            {
                const string errorName = "CURLIN_TPN_Therapy Form";
