...
{
    public class AdvanceDirectiveMentalHealthTreatmentClass
    {
        ...
        {
            var doc = Resources.AdvanceDirectiveMentalHealthTreatment;
            ...
            var fileName = Path.Combine(postPath, "AdvanceDirectiveMentalHealthTreatment.docx");
            try
            {
            ...
            {
                const string errorName = "Advance Directive Mental Health Treatment Form";
