...
{
    public class HomeInfusionReferralFormClass
    {
        ...
        {
            var doc = Resources.HomeInfusionReferralForm;
            ...
            var fileName = Path.Combine(postPath, "HomeInfusionReferralForm.pdf");
            try
            {
            ...
            {
                const string errorName = "HomeInfusionReferralForm Form";
