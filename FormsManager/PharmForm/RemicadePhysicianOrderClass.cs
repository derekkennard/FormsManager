...
{
    public class RemicadePhysicianOrderClass
    {
        ...
        {
            var doc = Resources.RemicadePhysicianOrder;
            ...
            var fileName = Path.Combine(postPath, "RemicadePhysicianOrder.pdf");
            try
            {
            ...
            {
                const string errorName = "RemicadePhysicianOrder Form";
