...
namespace FormsManager.PharmForm
{
    ...
    public class IhpDiabetes7_29_16Class
    {
        ...
        {
            var doc = Resources.IhpDiabetes7_29_16;
            ...
            var fileName = Path.Combine(postPath, "IhpDiabetes7_29_16.docx");
            try
            {
            ...
            {
                const string errorName = "IhpDiabetes7_29_16 Form";
