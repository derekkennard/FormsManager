...
{
    public class AetnaIgTherapyPrecertificationRequestFormClass
    {
        ...
        {
            var doc = Resources.AetnaIgTherapyPrecertificationRequestForm;
            ...
            var fileName = Path.Combine(postPath, "AetnaIgTherapyPrecertificationRequestForm.pdf");
            try
            {
            ...
            {
                const string errorName = "AetnaIgTherapyPrecertificationRequest Form";
