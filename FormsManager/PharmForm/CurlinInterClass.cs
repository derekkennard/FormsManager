...
namespace FormsManager.PharmForm
{
    public class CurlinInterClass
    {
        ...
        {
            var doc = Resources.Curlin_IntermittentTherapy;
            ...
            var fileName = Path.Combine(postPath, "Curlin_IntermittentTherapy.pdf");
            try
            {
            ...
            {
                const string errorName = "Curlin_IntermittentTherapy Form";
