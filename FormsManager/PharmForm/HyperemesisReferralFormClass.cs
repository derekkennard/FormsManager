...
{
    public class HyperemesisReferralFormClass
    {
        ...
        {
            var doc = Resources.HyperemesisReferralForm;
            ...
            var fileName = Path.Combine(postPath, "HyperemesisReferralForm.pdf");
            try
            {
            ...
            {
                const string errorName = "HyperemesisReferralForm Form";
